        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
          <div>
            ...
            <p className="text-portfolio-text/80 mb-4">
              ...
              love for creating seamless user experiences. With a background in
              both front-end and back-end development, I enjoy bringing ideas to
              life through code.
            </p>
            <p className="text-portfolio-text/80 mb-4">
              I'm constantly learning and exploring new technologies to stay at
              the cutting edge of web development. My goal is to build
          ...
          <div>
            ...
            <div className="mb-4">
              ...
              <p className="text-portfolio-text/70">
                Centennial college(PGWP course), Scarborough (Canada) 2024-2026
              </p>
            </div>
            <div className="mb-4">
              <h3 className="text-lg font-medium text-portfolio-text">
              ...
              <p className="text-portfolio-text/70">
                L.J. college (Gujarat Technology University), Ahmedabad (India)
                2020-2023
              </p>
            </div>
            <h2 className="text-xl font-semibold mt-8 mb-4 text-portfolio-primary">
