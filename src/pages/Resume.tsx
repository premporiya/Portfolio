        ...
        <div className="mt-8 p-6 bg-white/5 backdrop-blur-md rounded-lg">
          <section className="mb-8">
            ...
            <p className="text-portfolio-text/80 pl-7">
              Passionate and detail-oriented Web Developer with 5+ years of
              experience in creating responsive and user-friendly web
              applications. Proficient in modern front-end frameworks, back-end
          ...
          <section className="mb-8">
            ...
            <div className="pl-7 space-y-3">
              <div>
                ...
                <p className="text-sm text-portfolio-text/70">Udacity • 2021</p>
              </div>
              <div>
                <h4 className="text-portfolio-text/90 font-medium">
            ...
            <div className="pl-7 space-y-6">
              <div>
                ...
                <ul className="mt-2 space-y-1 list-disc list-inside text-sm text-portfolio-text/80">
                  <li>
                    Led a team of 5 developers in building responsive web
                    applications
                  </li>
                  <li>
